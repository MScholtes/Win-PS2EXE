...
namespace WPFApplication
{
	public class CustomWindow : Window
	{
		...
		{ // Get the XAML content from a string.
			...
			// search object of Button
			Button objButton4 = (Button)objWindow.FindName("IconFilePicker");
			// add event handlers
...
<local:CustomWindow
	...
	<Grid>
		...
		<TextBox x:Name=""SourceFile"" Height=""18"" Padding=""-2"" Margin=""0,0,10,0"" AllowDrop=""True"" ToolTip=""Path and name of the source file (the only mandatory field)"" Grid.Row=""1"" Grid.Column=""1"" />
		...
		<TextBox x:Name=""TargetFile"" Height=""18"" Padding=""-2"" Margin=""0,0,10,0"" AllowDrop=""True"" ToolTip=""Optional: Name and possibly path of the target file"" Grid.Row=""2"" Grid.Column=""1"" />

		<Label Grid.Row=""3"" Grid.Column=""0"">Icon file: </Label>
		<TextBox x:Name=""IconFile"" Height=""18"" Padding=""-2"" Margin=""0,0,10,0"" AllowDrop=""True"" ToolTip=""Optional: Name and possibly path of the icon file"" Grid.Row=""3"" Grid.Column=""1"" />
